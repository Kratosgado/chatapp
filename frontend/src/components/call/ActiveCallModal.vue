<template>
  <div v-if="isActive" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
    <div class="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-xl w-80 text-center">
      <div class="mb-4">
...
const isActive = computed(() => callsStore.callState === 'calling' || callsStore.callState === 'connected');
...
watch(() => callsStore.remoteStream, (stream) => {
